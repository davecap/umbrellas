...
def test_replica_parameters(tmpdir):
    ...
    params.update({ 'coordinates': PDB_small, 'intparam': 1, 'strparam': "teststring" })
    ...
    params = Replica.DEFAULTS.copy()
    params.update({ 'coordinates':PDB_small, 'intparam': 2, 'strparam': "newstring", 'specialparam': "special" })
    assert r.parameters == params
